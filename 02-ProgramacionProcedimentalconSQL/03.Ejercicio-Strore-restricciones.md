...
--Insersion de datos a tabla Cliente y Producto
...
--creacion de store procedure Registro de venta 
...
--EJECUCIOJN de Store procedure 

EXEC spu_Registrar_Venta @IdCliente = 'ALFKI',
 @IdProducto = 1, 
 @Cantidad = 5;
GO
...
El procedimiento fue diseñado con base en los siguientes puntos:

Se implementó manejo de errores con TRY...CATCH
Se utilizó una transacción para asegurar que todo se ejecute correctamente
Se valida que el cliente exista antes de registrar la venta
Se valida que el producto exista
Se verifica que haya suficiente existencia
Se toma el precio actual del producto directamente de la tabla
Se registra la venta y su detalle
